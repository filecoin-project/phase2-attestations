# Filecoin Trusted-Setup EmptySectorUpdate/SnapDeals
...
```
$ gpg --homedir keyring --pinentry-mode loopback --passphrase '' --quick-generate-key "Filecoin trusted-setup esu <participant's name>" ed25519 default none
